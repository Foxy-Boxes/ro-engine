...
int main(void){
    ...
    Mesh_new Cube;
    Cube.loadOBJfile("../assets/simple.obj");
    ...
    */
    ...
    {   
        ...
        if(render){
            ...
            Cube.transformMesh(matRotZ.mul(&matRotX)).offsetMesh(0,0,8);
            Cube.drawMesh(&windowinstance, &matProj);
            if(counter > (1 << 16)){
    ...
    literal_flusher<Vertex>();
    literal_flusher<Mesh_new::positions>();
}
